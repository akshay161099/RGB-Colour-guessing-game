...
hint.addEventListener("click",function(){
	alert("Welcome to color guessing game.This game is sponsored by Akshay.You have to guess a colour which matches the rgb value .If you guess correctly you win the game.Otherwise you lose.");
